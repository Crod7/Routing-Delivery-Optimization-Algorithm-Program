...
def run():
    # This empty Hash Table will hold all package data.
    database = HashTable.HashChain(10)                  

    # This will load the Hash Table with all the package data.
    loadPackageData("WGUPS Package File.csv", database) 

    # We make 3 Truck objects to deliver all the packages.
    truck1 = Truck(18, 0, "HUB", [], None, 0)           
    truck2 = Truck(18, 0, "HUB", [], None, 0)
    truck3 = Truck(18, 0, "HUB", [], None, 0)

    # We use this function to organize how all the packages will be
    # loaded into their respective Trucks and from what database.
    # In this case we use the three Truck objects and our
    # database Hash Table.
    organize(truck1, truck2, truck3, database)

    # This handles the Main Menu, allows the user to make a 
